...
const projects = projectsData.filter(p => p.domain === 'Web' || p.domain === 'Fullstack')

export default function WebDevProjectsNode() {
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-2 px-10 pt-5 pb-2 w-full shrink-0">
            <p className="text-[10px] font-semibold tracking-widest uppercase text-blue-400">Web Projects</p>
