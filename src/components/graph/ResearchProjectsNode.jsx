...
const projects = projectsData.filter(p => p.domain === 'Research' || p.domain === 'IoT')

export default function ResearchProjectsNode() {
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-2 px-10 pt-5 pb-2 w-full shrink-0">
            <p className="text-[10px] font-semibold tracking-widest uppercase text-indigo-400">Research Projects</p>
