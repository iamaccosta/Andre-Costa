            ...
            <div className="flex flex-col gap-6 p-6 flex-1">
                ...
                <div className="flex flex-col gap-3 pt-2">
                    <motion.a
                        href="#contact"
                        whileTap={{ scale: 0.97 }}
                        whileHover={{ scale: 1.02, boxShadow: isPopular ? "0 6px 28px rgba(245,158,11,0.35)" : `0 4px 20px ${accent}30` }}
                        className="w-full flex items-center justify-center py-3 rounded-xl text-sm font-bold transition-colors duration-200 cursor-pointer"
                        style={
                            isPopular
